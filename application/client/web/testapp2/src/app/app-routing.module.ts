...
{ path : 'add person', loadChildren: () => import('./add person/add person.module').then(m => m.Add personModule), canActivate: [AuthGuard] } , 
{ path : 'screen462318', loadChildren: () => import('./screen462318/screen462318.module').then(m => m.Screen462318Module), canActivate: [AuthGuard] } , 
];
